    ...
    public partial class Informes : Form
    {
        ...
        private void botonInforme_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    DgvInforme.Visible = false;
                    dgvChiCuadrado.Visible = false;
                    dgvKs.Visible = false;
                    dgvPoissonDist.Visible = true;
                    dgvChiPoisson.Visible = true;
                    label3.Text = "No se calcula KS";
                    limitesSup.Clear();
                    frecObservada.Clear();
                    dgvPoissonDist.Rows.Clear();
                    ...
                    for (int i = 0; i < items.Count(); i++)
                    {
                        ...
                        dgvPoissonDist.Rows.Add(fila);
                    }
                    var cantIntervalo = mostrarTablaChiPoisson(items);
                ...
                {
                    dgvKs.Visible = true;
                    DgvInforme.Visible = true;
                    dgvChiCuadrado.Visible = true;
                    dgvPoissonDist.Visible = false;
                    dgvChiPoisson.Visible = false;
                    decimal mayorKS;
                    List<Registro> items;
        ...
        public int mostrarTablaChiPoisson(List<Registro> items)
        {
                        ...
                        else
                        {
                            if (acumulados + items[i].FrecuenciaEsperada < 5)
                            {
                                ...
                                if (result)
                                {
                                    ...
                                    if (limite == items.Count() || !puedoAcumular(items, limite + 1)) acumuloRestante = true;
                                    limiteParcial = true;
                                }
                                else
                                {
